...
//		MetaModel::Init_SetZListItems('advanced_search', array('name')); // Criteria of the advanced search form
	...
	try
	{
	  	...
	  	$url = MetaModel::GetModuleSetting('ghrec-sms', 'url', '');
		$parameters['username'] = MetaModel::GetModuleSetting('ghrec-sms', 'username', '');
	    $parameters['password'] = MetaModel::GetModuleSetting('ghrec-sms', 'password', '');
	    $parameters['from'] = MetaModel::GetModuleSetting('ghrec-sms', 'from', '');
	    ...
	    $parameters['isflash'] = MetaModel::GetModuleSetting('ghrec-sms', 'isflash', '');
	    $parameters['udh'] = '';
	    $parameters['recId'] = '';
	    $parameters['status'] = '';
        ...
        $mobile_array=$parameters['to'];//حداکثر 100 شماره موبایل
        $msg_array=array($parameters['text']);
        $sms_number_array=array($parameters['from']);
        $messagid=rand();
        $mclass=array('');
	    ...
	    if ($oLog)
		  {
		    $oLog->Set('message', 'Result Code: '.$sRes->SendSmsResult);
		  }
